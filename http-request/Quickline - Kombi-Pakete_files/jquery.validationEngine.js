...
(function($) {
	...
	var methods = {
		...
		_buildPrompt: function(field, promptText, type, ajaxed, options) {
			...
			if(field.parents('label').length) {
				field.parents('label').after(prompt);
			} else if(field.prop('type') == 'radio') {
				field.parents('[class*=radio_outer]').append(prompt);
			} else if(field.parents('.selecter').length){
				field.parents('.selecter').append(prompt);
			} else {
				field.after(prompt);
			}
		...
		_getPrompt: function(field) {
			...
			//console.debug(formId,'   ',className);
